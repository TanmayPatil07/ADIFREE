...
<div class="days-info-container">
    <div class="font-days-color">
        <h1>DAY 15 SCHEDULE.</h1>
        <h2> Celebrating Two Weeks Smoke-Free</h2>
        <p><b>- "Two weeks without a cigarette, and you're proving that every craving you resist brings you one step closer to a healthier, smoke-free you."</b></p>
        <pre>
