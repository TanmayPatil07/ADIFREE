...
<div class="days-info-container">
    <div class="font-days-color">
        <h1>DAY 14 SCHEDULE.</h1>
        <h2>Celebrating Two Weeks Smoke-Free</h2>
        <p><b>- "Recovery is about progression, not perfection."</b></p>
        <pre>
          ...
          Continue to engage in smoke-free activities and hobbies.
          Stay vigilant for any unexpected triggers.
          Monitor your progress using your quit smoking app and set rewards for yourself.

            <hr>
            <b>Evening (4:00 PM - 8:00 PM)</b><br>
            Focus on relaxation and stress reduction to maintain your emotional well-being.
            Prepare a special dinner to celebrate your two-week achievement.
            Reflect on how your life has improved, and set new aspirations for the future.
            <hr>
