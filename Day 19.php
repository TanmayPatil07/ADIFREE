...
<div class="days-info-container">
    <div class="font-days-color">
        <h1>DAY 19 SCHEDULE.</h1>
        <h2>Strengthening Resolve</h2>
        <p><b>- "It does not matter how slowly you go as long as you do not stop. Your journey is about determination, not speed."</b></p>
        <pre>
