...
<div class="days-info-container">
    <div class="font-days-color">
        <h1>DAY 21 SCHEDULE.</h1>
        <h2>Embracing a Smoke-Free Future</h2>
        <p><b>- "The best time to quit smoking was yesterday. The second-best time is today. Embrace your smoke-free future with open arms, and let it be a beacon of health and happiness."</b></p>
        <pre>
