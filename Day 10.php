...
<div class="days-info-container">
    <div class="font-days-color">
        <h1>DAY 10 SCHEDULE.</h1>
        <h2>Embracing a Smoke-Free Lifestyle</h2>
        <p><b>- "Recovery is an acceptance of the past, a commitment to the present, and a hope for the future."</b></p>
        <pre>
