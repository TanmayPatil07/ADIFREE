...
<div class="days-info-container">
    <div class="font-days-color">
        <h1>DAY 8 SCHEDULE.</h1>
        <h2>Staying Committed</h2>
        <p><b>- "The first step in recovery is admitting you have a problem. The second step is deciding to do something about it."</b></p>
        <pre>
           ...
           Connect with your support network for ongoing motivation.
          ...
          Continue tracking your progress and setting rewards for yourself.
            ...
            Prepare a special dinner to mark another smoke-free milestone.
            Reflect on how your life has improved since quitting.
