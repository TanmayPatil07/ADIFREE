...
<div class="days-info-container">
    <div class="font-days-color">
        <h1>DAY 16 SCHEDULE.</h1>
        <h2>Staying Strong</h2>
        <p><b>- "Strength is not the absence of weakness, but the ability to persevere in spite of it. Stay strong, and your smoke-free journey will only make you stronger."</b></p>
        <pre>
